...
import manyavaarSmalllogo from "../Assets/manyavaarSmalllogo.jpg"
...
export default function AdminDashboard() {
  ...
  const user = JSON.parse(localStorage.getItem('Yuvrajuser'))
  ...
  return (
    <div className={styles.AdminDashboardContainer} >
      <div className={styles.ADMenueContainer}  >
        <img onClick={() => navigate('/')} src={manyavaarSmalllogo} alt="" />
        <div>
          <div>
