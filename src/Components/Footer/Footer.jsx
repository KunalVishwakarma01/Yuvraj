  ...
  return (
    <div>
      ...
      <div className={styles.FooterMiddle} >
        ...
        <div>
          ...
          <div className={styles.socialMediainHB} >
            ...
            <a href="https://twitter.com/Yuvraj_" target="_blank" ><BsTwitter /></a>
            <a href="https://www.instagram.com/yuvraj/" target="_blank" ><AiOutlineInstagram /></a>
            <a href="https://www.linkedin.com/company/yuvraj/" target="_blank" ><TfiLinkedin /></a>
            <a href="https://www.youtube.com/channel/yuvraj" target="_blank" ><TfiYoutube /></a>
            <a href="https://in.pinterest.com/yuvraj/" target="_blank" ><FaPinterestP /></a>
          </div>
        </div>
      </div>
      ...
      <div className={styles.lastFooterContainer} >
        ...
        <p>Manyavar. all rights reserved © 2025</p>
